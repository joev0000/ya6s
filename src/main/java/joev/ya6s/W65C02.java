...
public class W65C02 {
  ...
  private static final HalfStep[] HS_ABSOLUTE_X = new HalfStep[] {
    D_OPCODE,  R_PC_INC,
    D_ADL,     R_PC_INC,
    D_ADH,     R_PC,
    NOOP,      RW_AD_X_REG,
  ...
  private static final HalfStep[] HS_ABSOLUTE_X_RMW = new HalfStep[] {
    D_OPCODE,  R_PC_INC,
    D_ADL,     R_PC_INC,
    D_ADH,     R_PC,
    NOOP,      R_AD_X,
  ...
  private static final HalfStep[] HS_ABSOLUTE_Y = new HalfStep[] {
    D_OPCODE,  R_PC_INC,
    D_ADL,     R_PC_INC,
    D_ADH,     R_PC,
    NOOP,      RW_AD_Y_REG,
  ...
  private static final HalfStep[] HS_ABSOLUTE_INDEXED_INDIRECT_JUMP = new HalfStep[] {
    D_OPCODE, R_PC_INC,
    D_ADL,    R_PC_INC,
    D_ADH,    R_PC,
    NOOP,     R_AD_X,
    ...
    for(int opcode = 0; opcode < 256; opcode++) {
      ...
      switch(addressingMode) {
        ...
        case ABSOLUTE_X:
          switch(instructions[opcode]) {
            case ASL, ROL, LSR, ROR, DEC, INC:
                     halfsteps[opcode] = HS_ABSOLUTE_X_RMW; break;
            default: halfsteps[opcode] = HS_ABSOLUTE_X;
          }
          break;
